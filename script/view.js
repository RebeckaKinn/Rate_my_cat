...
function topRated(){
    ...
    <div class="top3Rated">
        ...
        <div class="TopRatedCat1"><img src="${model.cats[0].img}" style="height: 300px; width: auto"/></div>
        ...
        <div class="TopRatedCat2"><img src="${model.cats[1].img}" style="height: 300px; width: auto"/></div>
        ...
        <div class="TopRatedCat3"><img src="${model.cats[2].img}" style="height: 300px; width: auto"/></div>
